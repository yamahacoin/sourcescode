...
#if defined(NDEBUG)
# error "yamahacoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x197c0ea83d2d44e6b0e85d372bdcc39e143461d585ed90d0c9420ebc0d928f52");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // yamahacoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "yamahacoin Signed Message:\n";
...
{
    // yamahacoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 12 * 60;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // yamahacoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // yamahacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1470486907, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d52da152aa7e8080f8f5473c034a5ca57f126bd66b53276896713d9a471c693456fdc2d7bb3856b370b62faba23eabd33103be12579f61fc1af9144ce8610517") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1470486907;
        ...
        assert(block.hashMerkleRoot == uint256("0xb8baad53d3a91a072263b8265a4cfface6ea657b27ba3dfe37e93400b554f27e"));
...
unsigned char pchMessageStart[4] = { 0x1b, 0x6d, 0x06, 0x34 }; // yamahacoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("yamahacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("yamahacoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static yamahacoinMiner(CWallet *pwallet)
{
    printf("yamahacoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("yamahacoin-miner");
    ...
    try { loop {
        ...
        printf("Running yamahacoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("yamahacoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&yamahacoinMiner, pwallet));
}
